    ...
    <div class="max-w-7xl mx-auto">
      ...
      <div class="grid md:grid-cols-3 gap-8">
        <div class="card-bg p-8 border-b-4 border-medieval-gold rounded-t-lg">
          <div class="bg-medieval-gold/10 w-16 h-16 flex items-center justify-center rounded-full mb-6 mx-auto">
            <i class="fas fa-hammer text-medieval-gold text-2xl"></i>
          </div>
        ...
        <div class="card-bg p-8 border-b-4 border-gold rounded-t-lg">
